...
// 统一黑名单（用逗号隔开）
const blacklistText = "美女,小姐姐,颜值,美照,自拍,身材,穿搭,辣妹,纯欲,氛围感,项链,风格,pink,姐姐,写真,女友,约会,ootd,OOTD,cos,jk,丝袜,腿,明星,社交,王者荣耀,游戏,焦虑,日常,探店";

// 生成数组，并去掉多余空格
const unifiedBlacklist = blacklistText.split(/\s*,\s*/);
